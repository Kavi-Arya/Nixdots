...
const char *spcmd10[] = {"st", "-n", "btterm", "-g", "144x41", "-e", "bluetoothctl", NULL };
...
static Keychord keychords[] = {
  ...
  // {1, {{ MODKEY,                       XK_d}},      spawn, SHCMD("~/.local/bin/dmenuFUCKme.sh") },
  ...
  {2, {{ MODKEY,XK_s},{0, XK_v}},	   togglescratch,  {.ui = 8 } },
  {2, {{ MODKEY,XK_s},{0, XK_b}},	   togglescratch,  {.ui = 9 } },
